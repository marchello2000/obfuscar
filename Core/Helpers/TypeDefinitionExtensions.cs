...
#pragma warning restore 618
        ...
        static IDictionary<string, bool> MemoryCache = new Dictionary<string, bool>();

        public static bool IsResourcesType(this TypeDefinition type)
        {
            if (MemoryCache.ContainsKey(type.FullName))
                return MemoryCache[type.FullName];
            ...
            MemoryCache.Add(type.FullName, result);
            return result;
        }
